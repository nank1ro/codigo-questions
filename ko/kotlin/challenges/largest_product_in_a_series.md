...
1000자리 수에서 가장 큰 곱을 가지는 연속된 네 자리 숫자는 9 × 9 × 8 × 9 = 5832입니다.

# --instructions--

1000자리 수에서 연속된 n개의 자리 숫자의 가장 큰 곱을 찾는 함수를 작성하세요.
...
연속된 4개의 자리 숫자의 가장 큰 곱은 5832이어야 합니다

```kotlin
    tryCatch(largestProductInASeries(4) == 5832L)
```

연속된 13개의 자리 숫자의 가장 큰 곱은 23514624000이어야 합니다
