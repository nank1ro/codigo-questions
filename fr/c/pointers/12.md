...
Complète `divide` pour qu'elle stocke le quotient entier de `a` par `b` dans la variable vers laquelle `quotient` pointe, et le reste dans celle vers laquelle `remainder` pointe
...
`17` divisé par `5` doit donner le quotient `3` et le reste `2`
...
`20` divisé par `4` doit donner le quotient `5` et le reste `0`
...
`3` divisé par `7` doit donner le quotient `0` et le reste `3`
