...
Complète `sum_at` pour qu'elle renvoie la somme des valeurs vers lesquelles `a` et `b` pointent
...
En pointant vers `3` et `4`, la somme doit être `7`
...
En pointant vers `10` et `-10`, la somme doit être `0`
...
En passant deux fois la même adresse, sa valeur doit être doublée
