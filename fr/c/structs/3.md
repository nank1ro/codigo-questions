...
Complète `area` pour qu'elle renvoie l'aire du rectangle `r`, c'est-à-dire `width` multiplié par `height`
...
L'aire d'un rectangle `3` par `4` doit être `12`
...
L'aire d'un rectangle `5` par `5` doit être `25`
...
L'aire d'un rectangle `7` par `0` doit être `0`
