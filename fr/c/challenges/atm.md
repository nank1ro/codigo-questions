...
James voudrait retirer N dollars d'un guichet automatique.
Le distributeur n'acceptera la transaction que si N est un multiple de 5, et que le compte de James dispose de suffisamment d'argent pour effectuer le retrait (frais bancaires inclus).
...
2. Le solde initial de James est donné avec deux chiffres de précision et se situe dans la plage suivante : `0 < B <= 2000`.
