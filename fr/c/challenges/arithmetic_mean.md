...
La moyenne de `[1, 2, 3, 4, 5, 6, 7]` doit égaler 4.0
...
La moyenne de `[4, 5, 6]` doit égaler 5.0
...
La moyenne de `[12, 34, 56, 78]` doit égaler 45.0

```c
    double arr3[] = {12, 34, 56, 78};
    double length3 = 4;
    try_catch(mean(arr3, length3) == 45.0);
```
