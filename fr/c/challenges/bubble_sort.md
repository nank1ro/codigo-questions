...
Écrivez une fonction appelée `bubbleSort` qui trie un tableau d'entiers par ordre croissant.

Le tableau est trié sur place : `bubbleSort` reçoit un pointeur vers le tableau et sa longueur, et réorganise les éléments de ce même tableau.
...
Un tableau vide doit rester intact
