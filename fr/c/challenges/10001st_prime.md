...
exerciseType: 1
difficulty: 1
title: Le 10001e nombre premier
---

# --description--

En listant les six premiers nombres premiers : 2, 3, 5, 7, 11 et 13, on constate que le 6e nombre premier est 13. Quel est le `n`-ième nombre premier ?

# --instructions--

Écris une fonction `nthPrime` qui prend un entier `n` et retourne le `n`-ième nombre premier.
