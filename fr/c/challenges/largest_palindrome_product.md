...
exerciseType: 1
difficulty: 2
title: Plus grand produit palindromique
---
...
Écris une fonction `largestPalindromeProduct` qui prend un entier `n` et retourne le plus grand palindrome formé par le produit de deux nombres à `n` chiffres.
