...
Écris une fonction `binarySearch` qui prend un tableau d'entiers trié par ordre croissant, sa longueur et un entier cherché, et renvoie l'index de la valeur cherchée dans le tableau, ou `-1` lorsque la valeur n'est pas présente.
