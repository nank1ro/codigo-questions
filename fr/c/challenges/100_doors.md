...
La deuxième fois, visitez seulement chaque 2e porte (c.-à-d., porte #2, #4, #6, ...) et basculez-la.
...
Retournez le résultat final dans un tableau, avec uniquement le numéro de porte inclus dans le tableau s'il est ouvert.
