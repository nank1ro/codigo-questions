...
- Si le nombre n'est pas un multiple de `3` ou `5`, le nombre doit être en sortie seul comme indiqué dans les exemples ci-dessous.
- La sortie doit toujours être une chaîne même si elle n'est pas un multiple de `3` ou `5`.
