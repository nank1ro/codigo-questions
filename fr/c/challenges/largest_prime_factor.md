...
Les facteurs premiers de 13195 sont 5, 7, 13 et 29. Quel est le plus grand facteur premier d'un nombre donné ?

# --instructions--

Écris une fonction `largestPrimeFactor` qui prend un entier `long long` appelé `number` et retourne son plus grand facteur premier.
