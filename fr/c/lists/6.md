...
Complète `free_list` pour qu'elle libère chaque nœud de la liste commençant à `head`
...
Libérer une liste de trois nœuds doit appeler `free` trois fois
...
Libérer un seul nœud doit appeler `free` une fois
...
Libérer une liste vide ne doit pas planter et ne doit rien libérer
