...
Complète `length` pour qu'elle renvoie le nombre de nœuds de la liste commençant à `head`
...
La longueur d'une liste de trois nœuds doit être `3`
...
La longueur d'un seul nœud doit être `1`
...
La longueur d'une liste vide doit être `0`
