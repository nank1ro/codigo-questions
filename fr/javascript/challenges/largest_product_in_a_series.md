...
Les quatre chiffres adjacents du nombre à 1000 chiffres mentionné ci-dessous qui ont le plus grand produit sont 9 × 9 × 8 × 9 = 5832.

# --instructions--

Trouvez les `n` chiffres adjacents du nombre à 1000 chiffres qui ont le plus grand produit. Quelle est la valeur de ce produit ?
