...
Complétez le code in order to calculate the average for the following list of numbers `1, 4, 6, 7, 9`.
Utilisez `reducer()` function to calculate the sum of the numbers
