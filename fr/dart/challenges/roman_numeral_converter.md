...
Créez une fonction prenant un entier positif en tant que paramètre et retournant une chaîne contenant la représentation en chiffres romains de cet entier. Les chiffres romains modernes s'écrivent en exprimant chaque chiffre séparément, en commençant par le chiffre le plus à gauche et en ignorant tout chiffre ayant une valeur de zéro.
