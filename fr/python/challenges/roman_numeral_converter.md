...
Créez une fonction prenant un entier positif comme paramètre et retournant une chaîne contenant la représentation en chiffres romains de cet entier. Les chiffres romains modernes sont écrits en exprimant chaque chiffre séparément, en commençant par le chiffre le plus à gauche et en omettant tout chiffre ayant une valeur de zéro.
