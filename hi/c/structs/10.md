...
`deposit` को पूरा करें ताकि वह उस अकाउंट के `balance` में `amount` जोड़े जिसकी ओर `account` इशारा करता है
...
Depositing `50` on a balance of `100` must give `150`
...
Depositing `0` must leave the balance unchanged
...
Two deposits of `10` and `20` on an empty account must give `30`
