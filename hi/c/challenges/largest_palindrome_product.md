...
एक पैलिंड्रोमिक संख्या दोनों दिशाओं से एक जैसी पढ़ी जाती है। दो 2-अंकीय संख्याओं के गुणनफल से बनने वाला सबसे बड़ा पैलिंड्रोम 9009 = 91 × 99 है।

# --instructions--

दो `n`-अंकीय संख्याओं के गुणनफल से बनने वाला सबसे बड़ा पैलिंड्रोम ज्ञात करें।
...
`largest_palindrome_product(2)` का मान `9009` होना चाहिए।

```c
    try_catch(largest_palindrome_product(2) == 9009);
```

`largest_palindrome_product(1)` का मान `9` होना चाहिए।

```c
    try_catch(largest_palindrome_product(1) == 9);
```

`largest_palindrome_product(3)` का मान `906609` होना चाहिए।
