...
Четыре соседние цифры в 1000-значном числе, имеющие наибольшее произведение, — это 9 × 9 × 8 × 9 = 5832.

# --instructions--

Напишите функцию, которая находит n соседних цифр в 1000-значном числе с наибольшим произведением и возвращает это произведение.
