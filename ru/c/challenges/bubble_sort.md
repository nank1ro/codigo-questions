...
Напишите функцию с именем `bubbleSort`, которая сортирует массив целых чисел по возрастанию.

Массив сортируется на месте: `bubbleSort` получает указатель на массив и его длину и переставляет элементы этого же массива.
...
Пустой массив должен остаться нетронутым
