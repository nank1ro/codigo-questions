...
2520 — наименьшее число, которое делится без остатка на каждое из чисел от 1 до 10. Каково наименьшее положительное число, которое нацело делится на все числа от 1 до `n`?

# --instructions--

Напишите функцию `smallestMultiple`, которая принимает целое число `n` и возвращает наименьшее положительное число, нацело делящееся на все числа от 1 до `n`.
