...
Функция Аккермана -- это классический пример рекурсивной функции, примечательной тем, что она не является примитивно рекурсивной. Её значение растёт очень быстро, как и размер дерева вызовов.
