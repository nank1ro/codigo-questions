...
exerciseType: 1
difficulty: 1
title: Разность квадрата суммы и суммы квадратов
---
...
Напишите функцию `sumSquareDifference`, которая принимает целое число `n` и возвращает разность между квадратом суммы и суммой квадратов первых `n` натуральных чисел.
...
Разность квадратов сумм при n=10 должна быть равна 2640

```c
    try_catch(sumSquareDifference(10) == 2640);
```

Разность квадратов сумм при n=20 должна быть равна 41230

```c
    try_catch(sumSquareDifference(20) == 41230);
```

Разность квадратов сумм при n=100 должна быть равна 25164150
