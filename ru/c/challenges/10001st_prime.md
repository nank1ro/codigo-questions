...
Перечислив первые шесть простых чисел: 2, 3, 5, 7, 11 и 13, видим, что 6-е простое число равно 13. Каково `n`-е простое число?

# --instructions--

Напишите функцию `nthPrime`, которая принимает целое число `n` и возвращает `n`-е простое число.
