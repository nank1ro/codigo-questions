...
Входные данные представлены в следующем порядке:
1. сумма, которую Джеймс хочет снять, находится в следующем диапазоне: `0 < N <= 2000`.
2. начальный баланс Джеймса задаётся с точностью до двух знаков после запятой и находится в следующем диапазоне: `0 < B <= 2000`.
...
Транзакция отклонена, недопустимая сумма
