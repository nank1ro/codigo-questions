...
Простые множители числа 13195 — это 5, 7, 13 и 29. Каков наибольший простой множитель заданного числа?

# --instructions--

Напишите функцию `largestPrimeFactor`, которая принимает целое число типа `long long` с именем `number` и возвращает его наибольший простой множитель.
