...
`special_pythagorean_triplet(24)` должна возвращать 480.
...
`special_pythagorean_triplet(120)` должна возвращать 49920, 55080 или 60000.
...
`special_pythagorean_triplet(1000)` должна возвращать 31875000.
