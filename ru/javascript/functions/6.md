...
Завершите код in order to calculate the average for the following list of numbers `1, 4, 6, 7, 9`.
Используйте `reducer()` function to calculate the sum of the numbers
