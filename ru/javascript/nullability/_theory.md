...
// выводит missing missing
console.log(show(0), show(""));
// выводит present present
```
...
task.onDone?.();
// ничего не происходит, ошибки нет
```
...
console.log(options);
// выводит { retries: 0, timeout: 1000 }
```
...
// выводит пустую строку, потому что null преобразуется в 0
```
