...
Un triplete pitagórico es un conjunto de tres números naturales, `a` < `b` < `c`, para los cuales, <latex>a^2 + b^2 = c^2</latex>
...
`special_pythagorean_triplet(24)` debe devolver 480.
...
`special_pythagorean_triplet(120)` debe devolver 49920, 55080 o 60000.
...
`special_pythagorean_triplet(1000)` debe devolver 31875000.
