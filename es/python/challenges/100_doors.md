...
Hay 100 puertas en una fila que están todas cerradas inicialmente.
...
La tercera vez, visita cada 3ª puerta (es decir, puerta #3, #6, #9, ...), y así sucesivamente, hasta que solo visites la puerta número 100.

# --instructions--

Implementa una función para determinar el estado de las puertas después del último paso.
Devuelve el resultado final en un arreglo, incluyendo solo el número de puerta en el arreglo si está abierta.
