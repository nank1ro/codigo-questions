...
2520 es el número más pequeño que se puede dividir por cada uno de los números del 1 al 10 sin ningún residuo.

# --instructions--

¿Cuál es el número positivo más pequeño que se divide uniformemente por todos los números del 1 al `n`?
...
def smallest_multiple(n):
  def gcd(a, b):
    return a if b == 0 else gcd(b, a % b) # Algoritmo de Euclides
