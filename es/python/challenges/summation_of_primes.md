...
Encuentra la suma de todos los primos por debajo de `n`.
...
`prime_summation(17)` debe devolver 41.
...
`prime_summation(2001)` debe devolver 277050.
...
`prime_summation(140759)` debe devolver 873608362.
...
`prime_summation(2000000)` debe devolver 142913828922.
