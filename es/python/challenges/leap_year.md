...
En un año calendario hay exactamente 365.25 días. Pero, eventualmente, esto llevará a confusión porque los humanos normalmente cuentan por divisibilidad exacta de 1 y no con puntos decimales. Entonces, para evitar esto último, se decidió sumar todos los 0.25 días cada ciclo de cuatro años y dar a ese año 366 días (incluyendo el 29 de febrero como día intercalar) y llamarlo __año bisiesto__. Los otros tres años en el ciclo de cuatro años solo contendrían 365 días y __no serían años bisiestos__.
...
El uso de `month`, `day`, `if`, `else`, `elif`, `and`, `or` no está permitido.
