...
Completa `square` para que devuelva `n * n` como un `long`, sin desbordarse para valores grandes de `n`
...
`square(100000)` debe devolver `10000000000`

```c
    try_catch(square(100000) == 10000000000L);
```

`square(-2)` debe devolver `4`
