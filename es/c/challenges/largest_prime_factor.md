...
Los factores primos de 13195 son 5, 7, 13 y 29. ¿Cuál es el factor primo más grande de un número dado?

# --instructions--

Escribe una función `largestPrimeFactor` que reciba un entero `long long` llamado `number` y devuelva su factor primo más grande.
