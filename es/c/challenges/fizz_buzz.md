...
- Si el número dado es múltiplo de `3` y `5`, la salida debe ser `"FizzBuzz"`.
- Si el número no es múltiplo de `3` ni `5`, el número debe ser la salida como se muestra en los ejemplos a continuación.
- La salida siempre debe ser una cadena incluso si no es múltiplo de `3` ni `5`.
...
char* fizz_buzz(int number) {
    ...
    char* string_number = malloc(12); // Asumiendo un máximo de 11 caracteres para el número
