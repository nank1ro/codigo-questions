...
La primera vez, visitas cada puerta y 'alterna' la puerta (si la puerta está cerrada, ábrela; si está abierta, ciérrala).
La segunda vez, solo visita cada 2ª puerta (es decir, puerta #2, #4, #6, ...) y cámbiala.
La tercera vez, visita cada 3ª puerta (es decir, puerta #3, #6, #9, ...), etc., hasta que solo visites la puerta número 100.
