...
Completa `length` para que devuelva el número de nodos de la lista que empieza en `head`
...
La longitud de una lista de tres nodos debe ser `3`
...
La longitud de un único nodo debe ser `1`
...
La longitud de una lista vacía debe ser `0`
