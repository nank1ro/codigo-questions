...
Completa `sum_at` para que devuelva la suma de los valores a los que `a` y `b` apuntan
...
Apuntando a `3` y `4` la suma debe ser `7`
...
Apuntando a `10` y `-10` la suma debe ser `0`
...
Pasar la misma dirección dos veces debe duplicar su valor
