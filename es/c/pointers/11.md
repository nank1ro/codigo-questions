...
Completa `swap` para que intercambie los valores de las dos variables a las que `a` y `b` apuntan
...
Intercambiar `1` y `2` debe dar `2` y `1`
...
Intercambiar `-5` y `40` debe dar `40` y `-5`
...
Intercambiar dos veces debe restaurar los valores originales
