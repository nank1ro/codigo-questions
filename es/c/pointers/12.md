...
Completa `divide` para que guarde el cociente entero de `a` entre `b` en la variable a la que `quotient` apunta, y el resto en la que `remainder` apunta
...
`17` dividido por `5` debe dar cociente `3` y resto `2`
...
`20` dividido por `4` debe dar cociente `5` y resto `0`
...
`3` dividido por `7` debe dar cociente `0` y resto `3`
