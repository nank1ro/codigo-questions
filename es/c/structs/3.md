...
Completa `area` para que devuelva el área del rectángulo `r`, es decir `width` multiplicado por `height`
...
El área de un rectángulo de `3` por `4` debe ser `12`
...
El área de un rectángulo de `5` por `5` debe ser `25`
...
El área de un rectángulo de `7` por `0` debe ser `0`
