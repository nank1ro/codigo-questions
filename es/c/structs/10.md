...
Completa `deposit` para que sume `amount` al `balance` de la cuenta a la que apunta `account`
...
Depositar `50` sobre un saldo de `100` debe dar `150`
...
Depositar `0` debe dejar el saldo sin cambios
...
Dos depósitos de `10` y `20` en una cuenta vacía deben dar `30`
