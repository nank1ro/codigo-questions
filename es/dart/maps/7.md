...
Dado el mapa `scores`, crea una `List<String>` llamada `subjects` con sus claves y una `List<int>` llamada `points` con sus valores.
...
`subjects` debería ser `['math', 'art', 'gym']`
