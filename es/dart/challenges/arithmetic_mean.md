...
Escribe una funcion llamada `mean` para encontrar el _promedio aritmetico_ de un vector numerico.

# --instructions--

Escribe una funcion que devuelva la media de un vector numerico.
