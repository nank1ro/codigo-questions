...
La forma más simple de probar si un número es factor de otro es usar la operación módulo.
...
- no tiene ninguno de 3, 5, o 7 como factor, el resultado deben ser los dígitos del número.
...
- 34 no tiene factores de 3, 5, o 7, por lo que el resultado sería `"34"`.
