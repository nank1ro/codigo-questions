...
// imprime missing missing
console.log(show(0), show(""));
// imprime present present
```
...
console.log(options);
// imprime { retries: 0, timeout: 1000 }
```
...
// imprime una cadena vacía, porque null se convierte en 0
```
