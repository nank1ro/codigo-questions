...
Completa el código para crear una función válida llamada `sumAllNumbers` pasando el siguiente arreglo de números `[15, 24, 31, 79]` y `true` para imprimir el resultado
