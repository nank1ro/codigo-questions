...
// imprime 53
console.log(1 + 2 + "3");
// imprime 33, porque 1 + 2 se calcula primero
```
...
```javascript
console.log("5" == 5);
// imprime true, "5" se convierte en 5
console.log(0 == "");
// imprime true, "" se convierte en 0
...
// imprime bigint 9007199254740994n
```
