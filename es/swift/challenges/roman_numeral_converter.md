...
Crea un funcion tomando un positive integer como su parametro y devolviendo un cadena containing el Roman numeral representation de ese integer. Modern Roman numerals son escrito por expressing cada digit separately, empezando con el dejo mas digit y skipping cualquier digit con un valor de zero.
...
- All roman numerals deberia ser returned como uppercase.
- The largest numero ese puede ser represented en este notation es 3,999.
