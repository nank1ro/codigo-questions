...
Write a function called `bubbleSort` that sorts an array of integers into ascending order.

The array is sorted in place: `bubbleSort` receives a pointer to the array and its length, and rearranges the elements of that same array.
...
An empty array must be left untouched
