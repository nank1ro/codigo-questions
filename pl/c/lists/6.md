...
Uzupełnij `free_list`, aby zwalniała każdy węzeł listy zaczynającej się w `head`
...
Zwolnienie listy trzech węzłów musi wywołać `free` trzy razy
...
Zwolnienie pojedynczego węzła musi wywołać `free` raz
...
Zwolnienie pustej listy nie może powodować awarii i nie może nic zwolnić
