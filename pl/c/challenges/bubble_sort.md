...
Napisz funkcję o nazwie `bubbleSort`, która sortuje tablicę liczb całkowitych w kolejności rosnącej.

Tablica jest sortowana w miejscu: `bubbleSort` otrzymuje wskaźnik do tablicy oraz jej długość i zmienia kolejność elementów tej samej tablicy.
...
Pusta tablica musi pozostać nietknięta
