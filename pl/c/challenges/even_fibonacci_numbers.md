...
Rozważając wyrazy ciągu Fibonacciego, których wartości nie przekraczają danego limitu, znajdź sumę wyrazów parzystych.

# --instructions--

Napisz funkcję `fibonacciEvenSum`, która przyjmuje liczbę całkowitą `n` i zwraca sumę parzystych wyrazów Fibonacciego, których wartości nie przekraczają `n`.
