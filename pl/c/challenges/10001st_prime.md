...
Wypisując pierwsze sześć liczb pierwszych: 2, 3, 5, 7, 11 i 13, widzimy, że 6. liczba pierwsza to 13. Jaka jest `n`-ta liczba pierwsza?

# --instructions--

Napisz funkcję `nthPrime`, która przyjmuje liczbę całkowitą `n` i zwraca `n`-tą liczbę pierwszą.
