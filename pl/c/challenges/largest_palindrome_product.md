...
exerciseType: 1
difficulty: 2
title: Największy iloczyn palindromiczny
---
...
Napisz funkcję `largestPalindromeProduct`, która przyjmuje liczbę całkowitą `n` i zwraca największy palindrom będący iloczynem dwóch liczb `n`-cyfrowych.
