...
Czynniki pierwsze liczby 13195 to 5, 7, 13 i 29. Jaki jest największy czynnik pierwszy danej liczby?

# --instructions--

Napisz funkcję `largestPrimeFactor`, która przyjmuje liczbę całkowitą typu `long long` o nazwie `number` i zwraca jej największy czynnik pierwszy.
