...
Napisz funkcję `sumSquareDifference`, która przyjmuje liczbę całkowitą `n` i zwraca różnicę między kwadratem sumy a sumą kwadratów pierwszych `n` liczb naturalnych.
