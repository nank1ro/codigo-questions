...
Uzupełnij `area`, aby zwracała pole prostokąta `r`, czyli `width` pomnożone przez `height`
...
Pole prostokąta `3` na `4` musi wynosić `12`
...
Pole prostokąta `5` na `5` musi wynosić `25`
...
Pole prostokąta `7` na `0` musi wynosić `0`
