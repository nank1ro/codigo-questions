...
Uzupełnij `deposit`, aby dodawała `amount` do `balance` konta, na które wskazuje `account`
...
Wpłata `50` przy saldzie `100` musi dać `150`
...
Wpłata `0` musi pozostawić saldo bez zmian
...
Dwie wpłaty `10` i `20` na puste konto muszą dać `30`
