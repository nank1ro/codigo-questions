...
Uzupełnij `digit_value`, aby zwracała liczbę reprezentowaną przez znak cyfry `c` (na przykład `'7'` daje `7`)
...
`digit_value('7')` musi zwrócić `7`

```c
    try_catch(digit_value('7') == 7);
```

`digit_value('0')` musi zwrócić `0`

```c
    try_catch(digit_value('0') == 0);
```

`digit_value('9')` musi zwrócić `9`
