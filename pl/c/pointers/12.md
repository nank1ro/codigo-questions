...
Uzupełnij `divide`, aby zapisywała iloraz całkowity z dzielenia `a` przez `b` w zmiennej, na którą wskazuje `quotient`, a resztę w tej, na którą wskazuje `remainder`
...
`17` podzielone przez `5` musi dać iloraz `3` i resztę `2`
...
`20` podzielone przez `4` musi dać iloraz `5` i resztę `0`
...
`3` podzielone przez `7` musi dać iloraz `0` i resztę `3`
