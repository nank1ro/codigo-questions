...
Uzupełnij `swap`, aby zamieniała wartości dwóch zmiennych, na które wskazują `a` i `b`
...
Zamiana `-5` i `40` musi dać `40` i `-5`
...
Podwójna zamiana musi przywrócić wartości początkowe
