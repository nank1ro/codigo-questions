...
`prime_summation(17)` powinno zwrócić 41.
...
`prime_summation(2001)` powinno zwrócić 277050.
...
`prime_summation(140759)` powinno zwrócić 873608362.
...
`prime_summation(2000000)` powinno zwrócić 142913828922.
