...
`largest_prime_factor(2)` powinno zwrócić 2.
...
`largest_prime_factor(3)` powinno zwrócić 3.
...
`largest_prime_factor(5)` powinno zwrócić 5.
...
`largest_prime_factor(7)` powinno zwrócić 7.
...
`largest_prime_factor(8)` powinno zwrócić 2.
...
`largest_prime_factor(13195)` powinno zwrócić 29.
...
`largest_prime_factor(600851475143)` powinno zwrócić 6857.
