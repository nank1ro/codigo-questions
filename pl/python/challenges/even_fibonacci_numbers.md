...
Rozważając wyrazy ciągu Fibonacciego, których wartości nie przekraczają `n`, znajdź sumę wyrazów o wartościach parzystych.
...
`fibonacci_even_sum(8)` powinno zwrócić 10
...
`fibonacci_even_sum(10)` powinno zwrócić 10
...
`fibonacci_even_sum(34)` powinno zwrócić 44
...
`fibonacci_even_sum(60)` powinno zwrócić 44
...
`fibonacci_even_sum(1000)` powinno zwrócić 798
...
`fibonacci_even_sum(100000)` powinno zwrócić 60696
...
`fibonacci_even_sum(4000000)` powinno zwrócić 4613732
