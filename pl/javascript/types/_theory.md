...
// wypisuje number string boolean
let city;
...
// wypisuje 53
console.log(1 + 2 + "3");
// wypisuje 33, ponieważ 1 + 2 jest obliczane jako pierwsze
```
...
```javascript
console.log("5" == 5);
// wypisuje true, "5" staje się 5
console.log(0 == "");
// wypisuje true, "" staje się 0
...
// wypisuje bigint 9007199254740994n
```
