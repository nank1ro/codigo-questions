...
Completa `divide` in modo che memorizzi il quoziente intero di `a` diviso `b` nella variabile a cui `quotient` punta, e il resto in quella a cui `remainder` punta
...
`17` diviso `5` deve dare quoziente `3` e resto `2`
...
`20` diviso `4` deve dare quoziente `5` e resto `0`
...
`3` diviso `7` deve dare quoziente `0` e resto `3`
