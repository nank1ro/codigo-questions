...
Completa `swap` in modo che scambi i valori delle due variabili a cui `a` e `b` puntano
...
Scambiare `1` e `2` deve dare `2` e `1`
...
Scambiare `-5` e `40` deve dare `40` e `-5`
...
Scambiare due volte deve ripristinare i valori originali
