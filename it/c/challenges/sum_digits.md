...
```c
    try_catch(somma_cifre(12345) == 15);
```

La somma delle cifre di 57253 è 22

```c
    try_catch(somma_cifre(57253) == 22);
```

La somma delle cifre di 122 è 5

```c
    try_catch(somma_cifre(122) == 5);
```

La somma delle cifre di 91979997 è 60

```c
    try_catch(somma_cifre(91979997) == 60);
```

La somma delle cifre di 2147483647 è 46

```c
    try_catch(somma_cifre(2147483647) == 46);
```
