...
Scrivi una funzione `largestPalindromeProduct` che riceve un intero `n` e restituisce il palindromo più grande ottenuto dal prodotto di due numeri a `n` cifre.
