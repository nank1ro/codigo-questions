...
I fattori primi di 13195 sono 5, 7, 13 e 29. Qual è il fattore primo più grande di un numero dato?

# --instructions--

Scrivi una funzione `largestPrimeFactor` che riceve un intero `long long` chiamato `number` e restituisce il suo fattore primo più grande.
