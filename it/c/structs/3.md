...
Completa `area` in modo che restituisca l'area del rettangolo `r`, cioè `width` moltiplicato per `height`
...
L'area di un rettangolo `3` per `4` deve essere `12`
...
L'area di un rettangolo `5` per `5` deve essere `25`
...
L'area di un rettangolo `7` per `0` deve essere `0`
