...
Completa `free_list` in modo che liberi ogni nodo della lista a partire da `head`
...
Liberare una lista di tre nodi deve chiamare `free` tre volte
...
Liberare un singolo nodo deve chiamare `free` una volta
...
Liberare una lista vuota non deve andare in crash e non deve liberare nulla
