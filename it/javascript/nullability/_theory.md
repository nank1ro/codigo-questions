...
// stampa missing missing
console.log(show(0), show(""));
// stampa present present
```
...
task.onDone?.();
// non succede nulla, nessun errore
```
...
// stampa una stringa vuota, perché null viene convertito in 0
```
