...
Vervollständige `area`, sodass die Funktion die Fläche des Rechtecks `r` zurückgibt, also `width` mal `height`
...
Die Fläche eines Rechtecks `3` mal `4` muss `12` sein
...
Die Fläche eines Rechtecks `5` mal `5` muss `25` sein
...
Die Fläche eines Rechtecks `7` mal `0` muss `0` sein
