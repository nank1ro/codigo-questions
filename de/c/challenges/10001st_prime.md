...
exerciseType: 1
difficulty: 1
title: 10001. Primzahl
---

# --description--

Wenn wir die ersten sechs Primzahlen aufzählen: 2, 3, 5, 7, 11 und 13, erkennen wir, dass die 6. Primzahl 13 ist. Was ist die `n`-te Primzahl?

# --instructions--

Schreibe eine Funktion `nthPrime`, die eine ganze Zahl `n` entgegennimmt und die `n`-te Primzahl zurückgibt.
