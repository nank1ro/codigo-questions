...
Bei jeder erfolgreichen Abhebung berechnet die Bank `0,50$`.
...
2. James' anfänglicher Kontostand wird mit zwei Dezimalstellen angegeben und liegt in folgendem Bereich: `0 < B <= 2000`.

# --instructions--

Geben Sie den Kontostand nach der versuchten Transaktion zurück, angegeben als Zahl mit zwei Dezimalstellen.
