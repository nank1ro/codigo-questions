...
Ihre Aufgabe ist es, eine Zahl in einen String umzuwandeln, der Regentropfen-Geräusche entsprechend bestimmten möglichen Faktoren enthält.
Ein Faktor ist eine Zahl, die eine andere Zahl ohne Rest aufteilt.
Die einfachste Möglichkeit zu testen, ob eine Zahl ein Faktor einer anderen ist, ist die Verwendung der Modulo-Operation.
Die Regeln von Raindrops sind wie folgt:
...
- hat keine der Zahlen 3, 5 oder 7 als Faktor, sollte das Ergebnis die Ziffern der Zahl sein.
...
- 34 wird nicht durch 3, 5 oder 7 geteilt, daher wäre das Ergebnis `"34"`.
