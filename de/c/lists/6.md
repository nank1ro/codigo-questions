...
Vervollständige `free_list`, sodass es jeden Knoten der Liste ab `head` freigibt
...
Das Freigeben einer Liste mit drei Knoten muss `free` dreimal aufrufen
...
Das Freigeben eines einzelnen Knotens muss `free` einmal aufrufen
...
Das Freigeben einer leeren Liste darf nicht abstürzen und darf nichts freigeben
