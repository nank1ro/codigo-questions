...
Vervollständige `length`, sodass es die Anzahl der Knoten in der Liste ab `head` zurückgibt
...
Die Länge einer Liste mit drei Knoten muss `3` sein
...
Die Länge eines einzelnen Knotens muss `1` sein
...
Die Länge einer leeren Liste muss `0` sein
