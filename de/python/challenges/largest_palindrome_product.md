...
Eine Palindromzahl wird auf beide Seiten gleich gelesen. Das größte Palindrom, das aus dem Produkt von zwei 2-stelligen Zahlen gebildet wird, ist 9009 = 91 × 99.

# --instructions--

Finden Sie das größte Palindrom, das aus dem Produkt von zwei `n`-stelligen Zahlen gebildet wird.
