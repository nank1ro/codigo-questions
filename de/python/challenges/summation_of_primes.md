...
`prime_summation(17)` sollte 41 zurückgeben.
...
`prime_summation(2001)` sollte 277050 zurückgeben.
...
`prime_summation(140759)` sollte 873608362 zurückgeben.
...
`prime_summation(2000000)` sollte 142913828922 zurückgeben.
