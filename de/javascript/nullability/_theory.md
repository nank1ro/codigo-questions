...
// gibt missing missing aus
console.log(show(0), show(""));
// gibt present present aus
```
...
console.log(options);
// gibt { retries: 0, timeout: 1000 } aus
```
...
// gibt einen leeren String aus, weil null in 0 umgewandelt wird
```
