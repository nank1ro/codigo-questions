...
Vervollständigen Sie die Funktion, um das richtige Ergebnis durch Aufrufen der `power`-Funktion mit einer Basis von `4` und einem Exponenten von `5` auszudrucken
