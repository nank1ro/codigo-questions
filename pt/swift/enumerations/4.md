...
Itere sobre the enumeration in order to print each case.
`$0` is a shortand argument name which can be used to refer to o valors of the closure's arguments.
