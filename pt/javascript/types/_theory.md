...
// imprime true, porque Number("hello") é NaN
console.log(isNaN("42"));
// imprime false, porque Number("42") é 42
```
`Number.isNaN(value)` **não** converte: é `true` apenas quando `value` é realmente o número `NaN`:
```javascript
console.log(Number.isNaN("hello"));
// imprime false, uma string não é NaN
...
// imprime 53
console.log(1 + 2 + "3");
// imprime 33, porque 1 + 2 é calculado primeiro
```
...
```javascript
console.log("5" == 5);
// imprime true, "5" se torna 5
console.log(0 == "");
// imprime true, "" se torna 0
