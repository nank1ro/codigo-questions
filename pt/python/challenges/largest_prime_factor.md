...
`largest_prime_factor(3)` deve retornar 3.
...
`largest_prime_factor(5)` deve retornar 5.
...
`largest_prime_factor(7)` deve retornar 7.
...
`largest_prime_factor(8)` deve retornar 2.
