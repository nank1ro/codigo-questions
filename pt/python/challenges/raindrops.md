...
---
# --description--
Sua tarefa é converter um número em uma string que contém sons de gotas de chuva correspondentes a certos fatores potenciais.
Um fator é um número que divide uniformemente outro número, sem deixar resto.
A maneira mais simples de testar se um número é um fator de outro é usar a operação de módulo.
...
- não tem nenhum de 3, 5 ou 7 como fator, o resultado deve ser os dígitos do número.
# --instructions--
Escreva uma função que retorna a string correta, exemplos:

- 28 tem 7 como fator, mas não 3 ou 5, então o resultado seria `"Plong"`.
- 30 tem ambos 3 e 5 como fatores, mas não 7, então o resultado seria `"PlingPlang"`.
