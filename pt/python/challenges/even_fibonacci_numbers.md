...
# --instructions--
Considerando os termos na sequência de Fibonacci cujos valores não excedem `n`, encontre a soma dos termos com valor par.
# --seed--
```python
