...
Complete `divide` para que ela armazene o quociente inteiro de `a` por `b` na variável para a qual `quotient` aponta, e o resto naquela para a qual `remainder` aponta
...
`17` dividido por `5` deve dar quociente `3` e resto `2`
...
`20` dividido por `4` deve dar quociente `5` e resto `0`
...
`3` dividido por `7` deve dar quociente `0` e resto `3`
