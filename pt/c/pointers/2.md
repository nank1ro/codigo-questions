...
Complete `sum_at` para que ela retorne a soma dos valores para os quais `a` e `b` apontam
...
Apontando para `3` e `4` a soma deve ser `7`
...
Apontando para `10` e `-10` a soma deve ser `0`
...
Passar o mesmo endereço duas vezes deve dobrar seu valor
