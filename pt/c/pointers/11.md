...
Complete `swap` para que ela troque os valores das duas variáveis para as quais `a` e `b` apontam
...
Trocar duas vezes deve restaurar os valores originais
