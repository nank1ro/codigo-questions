...
An array stores múltiplos valores of a single type and uses **indexes** to distinguish these values.
...
Finally, `item1` and `item2` are o valors that we want to save in the array
