...
Complete `square` para que ela retorne `n * n` como um `long`, sem estourar para valores grandes de `n`
...
`square(100000)` deve retornar `10000000000`

```c
    try_catch(square(100000) == 10000000000L);
```

`square(-2)` deve retornar `4`
