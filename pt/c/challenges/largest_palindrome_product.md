...
Um número palíndromo é lido da mesma forma em ambos os sentidos. O maior palíndromo formado pelo produto de dois números de 2 dígitos é 9009 = 91 × 99.

# --instructions--

Escreva uma função `largestPalindromeProduct` que recebe um inteiro `n` e retorna o maior palíndromo formado pelo produto de dois números de `n` dígitos.
