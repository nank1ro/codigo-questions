...
Complete `area` para que ela retorne a área do retângulo `r`, ou seja, `width` multiplicado por `height`
...
A área de um retângulo de `3` por `4` deve ser `12`
...
A área de um retângulo de `5` por `5` deve ser `25`
...
A área de um retângulo de `7` por `0` deve ser `0`
