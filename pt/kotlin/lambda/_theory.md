...
val double: (Int) -> Int = { it * 2 } // mesma coisa
```
...
println(repeatTwice("a") { it + "!" })  // mesma coisa, com trailing lambda
```
...
println(numbers.filter(::isEven))      // [2, 4], mesma coisa
```
