...
Escreva uma função que encontre o maior produto de n dígitos adjacentes no número de 1000 dígitos.
...
O maior produto de 4 dígitos adjacentes deve ser 5832

```kotlin
    tryCatch(largestProductInASeries(4) == 5832L)
```

O maior produto de 13 dígitos adjacentes deve ser 23514624000
